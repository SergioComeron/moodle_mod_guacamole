...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configtext('guacamole_zone_cloud', get_string('proyectcloudzone', 'guacamole'), get_string('proyectcloudzone', 'guacamole'), 'europe-west1-b'));
