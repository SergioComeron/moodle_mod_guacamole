...
echo '  <span>' . s($noticemsg) . '</span>';
echo '  <a id="guac-reopen" href="#" target="_blank" class="alert-link" style="margin-left:.5rem;">';
echo '    ' . get_string('openvirtualmachine', 'guacamole') . ' ↗';
echo '  </a>';
echo '</div>';
echo "<script>";
echo "document.querySelector('.button') && document.querySelector('.button').addEventListener('click', function(){";
echo "  var u=" . json_encode($url) . ";";
echo "  document.getElementById('guac-reopen').href=u;";
echo "  document.getElementById('guac-notice').style.display='block';";
echo "  window.open(u,'_blank');";
echo "});";
echo "document.querySelector('.button2') && document.querySelector('.button2').addEventListener('click', function(){";
echo "  var u=" . json_encode($urlant) . ";";
echo "  document.getElementById('guac-reopen').href=u;";
echo "  document.getElementById('guac-notice').style.display='block';";
echo "  window.open(u,'_blank');";
echo "});";
